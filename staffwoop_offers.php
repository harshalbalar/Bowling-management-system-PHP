...
if(isset($_POST['add_product'])){
 ...
 if(isset($_GET['delete'])){
    ...
    header('location:staffwoop_offers.php');
 }
...
<head>
    ...
    <link rel="stylesheet" href="css/staffwoop_offer.css">
...
<body>
            ...
            <div class="container mt-5">
                ...
                <table class="table " id="myTable">
                    ...
                    <tbody>
                        ...
                        <?php
                    $sql = "SELECT * FROM `offers` WHERE `user_type` = '$place'";
            ...
            <div id="offer">
                ...
                <div class="addoffer">
                    <form action="" method="post" enctype="multipart/form-data">
                        <h2>Add Offers</h2>
                        <input type="hidden" name="user_type" value="<?php echo $_SESSION['place']; ?>">
    ...
    <section class="edit-product-form">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="update_user_type" value="<?php echo $_SESSION['place']; ?>">
...
?>
    ...
    <section class="show-products">
        ...
        <div class="box-container1">
            <?php
                $select_products = mysqli_query($conn, "SELECT * FROM `offers` WHERE `user_type` = '$place'") or die('query failed');
            ...
            <div class="box">
                ...
                <div class="button">
                    <a href="staffwoop_offers.php?update=<?php echo $fetch_products['id']; ?>" class="option-btn">update</a>
                    <a href="staffwoop_offers.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn"
