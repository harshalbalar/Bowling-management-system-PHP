...
if(isset($_GET['delete'])){
    ...
    mysqli_query($conn, "DELETE FROM `register` WHERE userid = '$delete_id'") or die('query failed');
            ...
            <table class="table " id="myTable">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        elseif($type == 'staff'){
                            $sql = "SELECT * FROM `register` where user_type = 'staff'";
                        }
                        elseif($type == 'customer'){
                            $sql = "SELECT * FROM `register` where user_type = 'customer'";
                        }
                        else{
                    ...
                    ?><tr>
                        ...
                        <td class='delete' onclick="return confirm('Delete this User?');"> <a href="admin_user.php?delete=<?php echo $row['userid'];?>" >Delete</a></td>
                    </tr>
                    <?php
                    }
                ?>
