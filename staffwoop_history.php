...
<head>
    ...
    <link rel="stylesheet" href="css/staffwoop_history.css">
    ...
    <div id="history">
        ...
        <table class="table " id="myTable">
            ...
            <tbody>
                    ...
                    <?php
                    $sql = "SELECT p.paid_amount, b.* FROM payment as p, book as b where b.payment_id = p.payment_id and b.userid = '$staffid'";
