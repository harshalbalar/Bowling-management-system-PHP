...
<head>
    ...
    <link rel="stylesheet" href="css/shott.css">
...
<body>
    ...
    <?php include 'nav.php'?>
        <div class="control">
            ...
            <div class="nav">
                <ul>
                    <li><a href="main.php">Home</a><span>>> Shott</span> </li>
                </ul>
            </div>
        </div>
        <div class="banner-text">
            <img src="images/shott.png" alt="">
        </div>
    </section>
    <div id="sidenav">
        <nav>
    ...
    <div id="about">
        <div class="aboutinfo">
            ...
            <p>It is not an ordinary game, but it is THE GAME at the UV-Lit bowling alley in Surat. Chose your shoe
                ...
                your bowling swag, it’s your right that comes with style at the biggest bowling alley of Shott. Once you
                start bowling, you couldn’t stop.</p>
            <a href="../project/booking.php"><button>Book Now</button></a>
        </div>
        <div class="aboutimg">
            <video autoplay loop muted plays-inline class src="images/shott.mp4"></video>
        </div>
    </div>
    <section id="footer">
        ...
        <div class="footer-row">
            <div class="footer-left">
                <h1><i class="fa-solid fa-bowling-ball"></i>shott</h1>
                <p>Dumas Rd, Near Valentine Multiplex,
                    Piplod, Surat, Gujarat 39500</p>
            </div>
